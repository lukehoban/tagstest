...
namespace Pulumi.Tagstest
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Tagstest.version.txt");
    ...
    internal sealed class TagstestResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public TagstestResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
